...
3, // Inner radius (just slightly larger than Saturn's scaled radius of 2.2)
 5, // Outer radius  
...
        radius: 0.12,
        distance: 4,
        speed: -0.015, // Negative speed for retrograde orbit
      },
    ],
  },
];
...
      // Skip if this child doesn't correspond to a moon (like Saturn's rings)
...
      // Rings will automatically rotate with Saturn since they're a child mesh
    })
  })
...
rings.position.x = Math.sin(rings.rotation.y) * 50;
 rings.position.z = Math.cos( rings.rotation.y) * 50;
